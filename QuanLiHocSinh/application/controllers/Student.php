...
class Student extends CI_Controller
{
    ...
    function teacher_list($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ('Giáo viên');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '')
    {
        ...
        $page_data['subjects']   = $this->db->get_where('teach', array(
            'class_id' => $student_class_id
        ))->result_array();
        $page_data['class_id']   = $student_profile->class_id;
        $page_data['page_name']  = 'subject';

        $page_data['page_title'] = ('Môn học');
        $this->load->view('backend/index', $page_data);
        $this->load->view('backend/student/subject', $page_data);
    }
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        $page_data['class_id'] = $student_profile->class_id;
        $class_info = $this->db->get_where('class', array('class_id' => $student_profile->class_id))->row();
        $page_data['department_id'] = $class_info->department_id;
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['department_id'] > 0 && $page_data['class_id'] > 0 ) {
                redirect(base_url() . 'index.php?student/marks/' . $page_data['exam_id'] . '/' . $page_data['department_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
                $this->load->view('backend/student/marks', $page_data);
            } else {
        ...
        $page_data['page_title'] = ('Điểm kiểm tra');
        $this->load->view('backend/index', $page_data);
        $this->load->view('backend/student/marks', $page_data);
    }
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['class_id']   = $student_profile->class_id;
        $page_data['name']   = $student_profile->name;
        $page_data['page_name']  = 'class_routine';
        $page_data['page_title'] = ('Lịch học');
        $this->load->view('backend/index', $page_data);
       // $this->load->view('backend/student/class_routine', $page_data);
    }
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ('Thông báo');
        $this->load->view('backend/index', $page_data);
    ...
    function document($do = '', $document_id = '')
    {
        ...
        $page_data['page_title'] = ('Tài liệu học tập');
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ('Trang cá nhân');
    ...
    function study_material($task = "", $document_id = "")
    {
        ...
        $data['page_title']             = ('Tài liệu học tập');
