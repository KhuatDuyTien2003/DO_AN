...
class Teacher extends CI_Controller
{
    ...
    function student_add()
	{
		...
		$page_data['page_title'] = get_phrase('Thêm học sinh');
		$this->load->view('backend/index', $page_data);
	}
	...
	function student_information($class_id = '')
	{
		...
		$page_data['page_title'] 	= get_phrase('Thông tin học sinh'). " ".get_phrase('lớp')." : "
	...
	function student_marksheet($class_id = '')
	{
		...
		$page_data['page_title'] 	= get_phrase('Bảng điểm '). " ".get_phrase('lớp')." : ".
											$this->crud_model->get_class_name($class_id);
		$page_data['class_id'] 	= $class_id;
		$this->load->view('backend/index', $page_data);
	}
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $s['pname'] = $this->input->post('pname');
            $s['pemail'] = $this->input->post('pemail');
            $s['psex'] = $this->input->post('psex');
            $s['ppassword'] = $this->input->post('ppassword');
            $s['phone'] = $this->input->post('phone');
            $s['profession'] = $this->input->post('profession');

            $this->db->insert('student', $data);
            $this->db->insert('parent', $s);
    ...
    function teacher_list($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('Danh sách giáo viên');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('Quản lý môn học');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function marks($exam_id = '', $department_id='', $class_id = '', $subject_id = '')
    {
        if ($this->session->userdata('teacher_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['department_id'] > 0) {
                redirect(base_url() . 'index.php?teacher/marks/' . $page_data['exam_id'] . '/' . $page_data['department_id'] .'/'  . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
        ...
        $page_data['page_title'] = get_phrase('Quản lý điểm');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('Trang cá nhân');
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('Lịch học');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('Quản lý thư viện');
        $this->load->view('backend/index', $page_data);
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('Bảng thông báo');
    ...
    function study_material($task = "", $document_id = "")
    {
        ...
        $data['page_title']             = get_phrase('Tài liệu');
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '') {
        ...
        $page_data['page_title']                = get_phrase('Viết thư');
        $this->load->view('backend/index', $page_data);
    }
}