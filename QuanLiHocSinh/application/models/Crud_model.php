...
class Crud_model extends CI_Model {
    ...
    //     $query = $this->db->get_where('grade', array('level_id' => $level_id));
    //     return $query->result_array();
    // }

    function get_teacher($subject_id)
    {
        $query = $this->db->get_where('teacher', array('subject_id' => $subject_id));
        return $query->result_array();
    }
    ...
    function get_subjects_by_class($class_id) {
        // $sql = ""
        $query = $this->db->get_where('grade', array('class_id' => $class_id));
        return $query->result_array();
    }
    function get_subjects_by_student($student_id,$class_id , $exam_id) {
        // $sql = ""
        $query = $this->db->get_where('grade', array('student_id' => $student_id,'class_id' => $class_id, 'exam_id' => $exam_id));
        return $query->result_array();
    }
    function get_subjects_by_level($level_id) {
        // $sql = ""
        $query = $this->db->get_where('subject', array('level_id' => $level_id));
        return $query->result_array();
    }
    function get_classes_by_department($department_id) {
        // $sql = ""
        $query = $this->db->get_where('class', array('department_id' => $department_id));
        return $query->result_array();
    }
  
    function get_levels_by_department($department_id) {
        $query = $this->db->get_where('class', array('department_id' => $department_id));
        return $query->result_array();
    }
    ...
    ////////////CLASS///////////
    function get_class_name($department_id) {
        $query = $this->db->get_where('class', array('department_id' => $department_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['name'];
