    ...
    <div class="col-md-12">
        ...
        <div class="tabs-vertical-env">
            ...
            <ul class="nav tabs-vertical">
                <li class="active"><a href="#b-profile" data-toggle="tab">Lựa chọn dịch vụ SMS</a></li>
                <li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="active_sms_service" class="form-control">
                                ...
                                <option value="twilio" <?php if ($active_sms_service == 'twilio') echo 'selected';?>>
                                    Twilio
                                </option>
                                <option value="disabled"
                                    <?php if ($active_sms_service == 'disabled') echo 'selected';?>>
                                    <?php echo ('Disabled');?>
                                </option>
                            </select>
                        </div>
